...
if api_handler.response_data.get('ddos_mode', False) or (api_handler.response_data.get('blocked_ips', False) and api_handler.response_data.get('whitelisted_ips', False)):  
